            ...
            Container(
                ...
                child: PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return currentPage2 == 0? SingleChildScrollView(
                        child: Column(
                          children: [
                            Container(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Spacer(flex: 3),
                                      Icon(Icons.lock_outline, color: kPrimaryBlue),
                                      Text("Show CVV",
                                          style: GoogleFonts.poppins(
                                              color: kPrimaryBlue, fontSize: 16, fontWeight: FontWeight.w500)),
                                      Spacer(),
                                    ],
                                  ),
                                  Divider(
                                    ...
                                    children: [
                                      ...
                                      RichText(
                                        text: TextSpan(
                                            ...
                                            children: [
                                              TextSpan(
                                                  text: "\n"+cardData[currentPage]["withlimit"],
                                                  style: GoogleFonts.poppins(
                                                      color: Colors.black,
                                                      fontSize: 16,
                                                      fontWeight: FontWeight.w500))
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        height: 55,
                                        width: 55,
                                        child: Center(child: Icon(Icons.pattern)),
                                      ),
                                      Spacer(flex: 5,),
                                      Text("Change Pin", style: GoogleFonts.poppins(fontSize: 16, color: Colors.black),),
                                      Spacer(flex: 75,)
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Spacer(flex: 5,),
                                      Text("Block Card", style: GoogleFonts.poppins(fontSize: 16, color: Colors.black),),
                                      Spacer(flex: 75,)
                                    ],
                                  ),
                                  Divider(thickness: 1, indent: 15, endIndent: 15),
                                  Row(
                                    children: [
                                      ...
                                      Spacer(flex: 5,),
                                      Text("Change Limit", style: GoogleFonts.poppins(fontSize: 16, color: Colors.black),),
                                      Spacer(flex: 75,)
                                    ],
                                  )
                                ],
                      ...
                      ):Center(child: Container(height: 50, width: 50, child: CircularProgressIndicator(color: kPrimaryBlue,)));
                    }))
          ],
        ),
      ),
